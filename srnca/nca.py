...
class NCA(nn.Module):
    ...
    def calc_alive_mask(self, state_grid):
        # alpha value must be greater than 0.1 to count as alive
        alive_mask = state_grid[:,3:4,:,:] > self.alive_mask_threshold
    ...
    def forward(self, grid):
        ...
        if self.alive_mask_threshold:
          alive_mask = self.calc_alive_mask(new_grid) 
